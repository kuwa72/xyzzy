...
LONG
GlobalIME::xImmGetCompositionString (HIMC himc, DWORD index, void *buf, DWORD bufl)
{
#ifdef HAVE_DIMM_H
  if (gi_app)
    {
...
LONG
GlobalIME::xImmGetCompositionStringW (HIMC himc, DWORD index, void *buf, DWORD bufl)
{
#ifdef HAVE_DIMM_H
  if (gi_app)
    {
